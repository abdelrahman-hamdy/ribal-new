...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i79.LabelRepository>(
        () => _i79.LabelRepository(gh<_i367.FirestoreService>()));
    ...
    gh.lazySingleton<_i373.SettingsRepository>(
        () => _i373.SettingsRepository(gh<_i367.FirestoreService>()));
    gh.lazySingleton<_i515.TaskRepository>(
        () => _i515.TaskRepository(gh<_i367.FirestoreService>()));
    ...
    gh.lazySingleton<_i232.StatisticsRepository>(
        () => _i232.StatisticsRepository(gh<_i367.FirestoreService>()));
    gh.lazySingleton<_i517.UserRepository>(
        () => _i517.UserRepository(gh<_i367.FirestoreService>()));
    gh.lazySingleton<_i169.AssignmentRepository>(
        () => _i169.AssignmentRepository(gh<_i367.FirestoreService>()));
