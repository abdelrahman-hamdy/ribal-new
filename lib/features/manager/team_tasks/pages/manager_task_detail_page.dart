...
class ManagerTaskDetailPage extends StatelessWidget {
  ...
  const ManagerTaskDetailPage({super.key, required this.taskId});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const _ManagerTaskDetailContent(),
    );
  }
}

class _ManagerTaskDetailContent extends StatelessWidget {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _ActionsSection(
                    state: state,
                    onEdit: () => context.push(Routes.managerTaskEditPath(state.taskId!)),
...
/// Actions section with edit, delete and archive buttons
